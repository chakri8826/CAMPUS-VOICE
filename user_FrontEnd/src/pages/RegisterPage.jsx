  ...
  <form onSubmit={handleSubmit} className="w-full max-w-[480px] space-y-6">
    <div className="flex flex-col gap-1 px-4">
      <label className="flex flex-col">
        <input
          ...
          required
          className={`form-input rounded-lg text-white focus:outline-0 focus:ring-0 border-none bg-[#214a3c] h-14 placeholder:text-[#8ecdb7] p-4 text-base ${errors.name ? 'border border-red-500' : ''}`}
        />
    ...
    <div className="flex flex-col gap-1 px-4">
      <label className="flex flex-col">
        <input
          ...
          onChange={handleChange}
          required
          className={`form-input rounded-lg text-white focus:outline-0 focus:ring-0 border-none bg-[#214a3c] h-14 placeholder:text-[#8ecdb7] p-4 text-base ${errors.email ? 'border border-red-500' : ''}`}
        />
    ...
    <div className="flex flex-col gap-1 px-4">
      <label className="flex flex-col">
        <select
          ...
          onChange={handleChange}
          required
          className={`form-input rounded-lg text-white focus:outline-0 focus:ring-0 border-none bg-[#214a3c] h-14 placeholder:text-[#8ecdb7] p-4 text-base ${errors.department ? 'border border-red-500' : ''}`}
        >
    ...
    <div className="flex flex-col gap-1 px-4">
      <label className="flex flex-col">
        <input
          ...
          onChange={handleChange}
          required
          className={`form-input rounded-lg text-white focus:outline-0 focus:ring-0 border-none bg-[#214a3c] h-14 placeholder:text-[#8ecdb7] p-4 text-base ${errors.password ? 'border border-red-500' : ''}`}
        />
    ...
    <div className="flex px-4">
      <button
        type="submit"
        disabled={loading}
        className="w-full h-12 px-4 rounded-lg bg-[#019863] text-white text-sm font-bold hover:bg-[#017a4f] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {loading ? 'Registering...' : 'Register'}
            ...
            <Link to="/login" className="text-[#8ecdb7] text-lg font-normal leading-normal pb-3 pt-1 px-4 text-center underline hover:text-white transition-colors">
